...
--=============================================================================================================
CREATE PROCEDURE [test].[test_087_fnSplitQualifiedTableName]
AS
BEGIN
DECLARE
   ...
   -- 1 off setup  ??
   EXEC test.hlpr_087_fnSplitQualifiedTableName '001','test.fnGetRtnNmBits','test','fnGetRtnNmBits';
   EXEC test.hlpr_087_fnSplitQualifiedTableName '002','a.b','a','b';
   EXEC test.hlpr_087_fnSplitQualifiedTableName '003','a.b.c','a','b.c';
   EXEC test.hlpr_087_fnSplitQualifiedTableName '004',null,null,null;
   EXEC test.hlpr_087_fnSplitQualifiedTableName '005','',null,null;
   EXEC test.hlpr_087_fnSplitQualifiedTableName '006','xyz','dbo','xyz';

   EXEC sp_log 2, @fn, '99: All subtests PASSED'
   EXEC test.sp_tst_mn_cls;
END
/*
EXEC test.test_087_fnSplitQualifiedTableName;

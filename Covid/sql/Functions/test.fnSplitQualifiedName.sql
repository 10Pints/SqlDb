...
END
/*
SELECT * FROM test.fnSplitQualifiedName(''test.fnGetRtnNmBits'')
SELECT * FROM test.fnSplitQualifiedName(''a.b'')
SELECT * FROM test.fnSplitQualifiedName(''a.b.c'')
SELECT * FROM test.fnSplitQualifiedName(''a'')
SELECT * FROM test.fnSplitQualifiedName(null)
SELECT * FROM test.fnSplitQualifiedName('''')
*/
